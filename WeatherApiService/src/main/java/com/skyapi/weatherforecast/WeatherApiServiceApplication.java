...
public class WeatherApiServiceApplication {
    ...
    public ModelMapper getModelMapper() {
        ...
        TypeMap<HourlyWeatherDTO, HourlyWeather> typeMap2 = mapper.typeMap(HourlyWeatherDTO.class, HourlyWeather.class);
        typeMap2.addMapping(HourlyWeatherDTO::getHourOfDay, (dest, value) -> dest.getId().setHourOfDay(value != null ? (Integer) value : 0));
